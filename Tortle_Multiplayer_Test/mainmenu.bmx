...
Global selected_r = 255
Global selected_g = 255
Global selected_b = 255
...
Function handle_menu_buttons()
	...
	For b:button = EachIn button_list
		If b.active Then
			If mouseinrect(b.x,b.y,b.width,b.height) And b.active = True Then
	...
	If left_smile.clicked = True Then
		...
		If smile_selected < 0 Then smile_selected = 3
	...
	If right_smile.clicked = True Then
		...
		If smile_selected > 3 Then smile_selected = 0
	...
	If left_eyes.clicked = True Then
		...
		If eyes_selected < 0 Then eyes_selected = 3
	...
	If right_eyes.clicked = True Then
		...
		If eyes_selected > 3 Then eyes_selected = 0
